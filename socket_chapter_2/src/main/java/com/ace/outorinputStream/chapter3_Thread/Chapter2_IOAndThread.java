 ...
 */
public class Chapter2_IOAndThread implements Runnable{

	private String fileName;
	private InputStream is ;
	private static String pathPrv = "D:\\TeamFile\\temp";
	
	public Chapter2_IOAndThread() {
		
	}
	
	public Chapter2_IOAndThread(String fileName) {
	...
	public static void main(String[] args) {
		...
		for(int i=1;i<=len;i++) {
			...
			Thread tread = new Thread(new Chapter2_IOAndThread(tempPathName));
			tread.start();
		}
